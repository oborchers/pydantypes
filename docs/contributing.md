...
Four type patterns exist in the codebase (A/B/C/D). See [ARCHITECTURE.md](https://github.com/oborchers/pydantypes/blob/main/ARCHITECTURE.md) for full details, examples, and conventions for each pattern.
